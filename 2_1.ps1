...
# b.	В некоторые документы внести изменения и сохранить
# c.	Импортировать файл XML из 1.а
# d.	Сравнить времена последних изменений и вывести имена тех документов, к которые были внесены изменения
